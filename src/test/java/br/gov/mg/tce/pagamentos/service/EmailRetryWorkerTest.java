...
class EmailRetryWorkerTest {
    ...
    void shouldLockEmailWhileProcessing() {
        ...
        // Cria flag para capturar o estado interno no momento da chamada
        final boolean[] wasLocked = {false};

        // Configura o mock para interceptar o PRIMEIRO save
        doAnswer(invocation -> {
            EmailOutbox savedEmail = invocation.getArgument(0);
            // Se for o momento do lock (antes de enviar), captura o valor
